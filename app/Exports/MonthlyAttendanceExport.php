...
class MonthlyAttendanceExport implements FromArray, WithHeadings, WithTitle, ShouldAutoSize, WithStyles, WithCustomStartCell
{
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        // Title of report
        $sheet->setCellValue('A7', 'LAPORAN REKAPITULASI PRESENSI BULANAN');

        // Filter info
        $sheet->setCellValue('A8', "Kelas: {$this->className}   |   Periode: {$this->period}   |   Tanggal Cetak: " . \Carbon\Carbon::now()->locale('id')->isoFormat('D MMMM Y HH:mm'));
